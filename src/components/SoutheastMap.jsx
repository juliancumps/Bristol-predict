                ...
                <div className="split-item tableau-item" style={{width: '50%', height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f5f5f5'}}>
                  <a 
                    ...
                    style={{
                      ...
                      padding: '16px 32px',
                      backgroundImage: 'linear-gradient(155deg, #1f77b4 0%, #15aa9e 100%)',
                      color: 'white',
                      textDecoration: 'none',
                      borderRadius: '15px',
                      fontSize: '16px',
                    ...
                    onMouseOver={(e) => e.target.style.backgroundImage = 'linear-gradient(155deg, #15aa9e 0%, #1f77b4 100%)'}
                    onMouseOut={(e) => e.target.style.backgroundImage = 'linear-gradient(155deg, #1f77b4 0%, #15aa9e 100%)'}
                  >
                    View Salmon Caught by Gear Type →
                  </a>
                </div>
              </div>
            </div>
